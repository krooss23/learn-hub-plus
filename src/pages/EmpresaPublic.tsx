...
const CARDS = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-8 h-8 text-teal-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        ...
        <path d="M9 17v-6M15 17v-2M12 17v-4" stroke="currentColor" strokeWidth="2" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg className="w-8 h-8 text-teal-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        ...
        <path d="M6 18v-1a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v1" stroke="currentColor" strokeWidth="2" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg className="w-8 h-8 text-teal-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        <path d="M21 15a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" stroke="currentColor" strokeWidth="2" />
...
export default function EmpresaPublic() {
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-8">Bienvenido, {empresa.nombre}.</h1>
          ...
          >
            ...
            {card.key === "profile" && (
              <div className="mt-2 text-sm text-gray-700">
                <b>País:</b> {empresa.pais}<br />
                <b>Región:</b> {empresa.region}<br />
                <b>Zona:</b> {empresa.zona}<br />
